...
final musicPlayerViewModel = ChangeNotifierProvider.family(
  (ref, MusicModel musicModel) => MusicPlayerViewModel(musicModel: musicModel),
);

class MusicPlayerViewModel extends ChangeNotifier {
  MusicPlayerViewModel({required this.musicModel}) {
    _initAudioPlayer();
  }
  ...
  Future<int> play() async {
    final playPosition = (position != null &&
        ...
        ? position
        : null;
    final result = await audioPlayer.play(musicModel.music!,// //Mina Removing musicId class 5/1/2022
