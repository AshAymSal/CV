...
class CodeForgetView extends StatelessWidget {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomText(
                          ...
                          color: darkColor,
                          fontSize: 14,
                          text: 'usamaaelgendy@gmail.com ارسل الي',
                        ),
                        SizedBox(
                          height: 45,
                        ),
                  ...
                  return Form(
                    ...
                    child: Padding(
                      ...
                      child: PinCodeTextField(
                        ...
                        onCompleted: (v) {
                          print(viewModel.codeFromRequestMsg);
                        },
                      ...
                      onPressed: () {
                        ...
                        if (viewModel.otpController.text.length != 6 ||
                            viewModel.otpController.text !=
                                viewModel.codeFromRequestMsg) {
                          viewModel.errorController!.add(ErrorAnimationType
