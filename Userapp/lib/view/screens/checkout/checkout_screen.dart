...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
    ...
    if (_isLoggedIn) {
      ...
      // _selectedBranch =
      //   Provider.of<SplashProvider>(context, listen: false).selectedBranch;
                                                                ...
                                                                if (!_isAvailable) {
                                                                  double
                                                                      ...
                                                                      Geolocator
                                                                              .distanceBetween(
                                                                            //double.parse(_branches[order.branchIndex].latitude),
                                                                            double.parse(_selectedBranch.latitude),
                                                                            //double.parse(_branches[order.branchIndex].longitude),
                                                                            double.parse(_selectedBranch.longitude),
                                                                            double.parse(address.addressList[index].latitude),
                                                                            double.parse(address.addressList[index].longitude),
                                                                          ) /
                                                                          1000;
