...
class SelectBranchScreen extends StatelessWidget {
  ...
  // SelectBranchScreen({@required this.drawerController});
  List<Branches> _branches = [];
  // SelectBranchScreen({Key key}) : super(key: key);
                  ...
                  onTap: () {
                    ...
                    try {
                      /*order.setBranchIndex(index);
                                          ...
                                          _setMarkers(index);*/
                      //  Provider.of<SplashProvider>(context, listen: false)
                      //    .setSelectedBranch(_branches[index]);
                    } catch (e) {}
                  },
                  child: Container(
...
class _MenuScreenState extends State<MenuScreen> {
  ...
  Widget build(BuildContext context) {
    return CustomDrawer(
      ...
      //mainScreen: SelectBranchScreen(drawerController: _drawerController),
      showShadow: false,
      angle: 0.0,
      borderRadius: 30,
                          ...
                          builder: (context, splash, child) {
                            return Column(children: [
                              ...
                              MenuButton(
                                  ...
                                  title:
                                      getTranslated('shopping_bag', context)),
                              MenuButton(
                                  drawerController: drawerController,
                                  index: 3,
                              ...
                              ListTile(
                                ...
                                leading: Image.asset(
                                  _isLoggedIn ? Images.log_out : Images.log_out,
