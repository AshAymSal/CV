...
Widget ListKids(BuildContext context, double width) {
  return Material(
      elevation: 250,
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  Text(
                    AppLocalizations.of(context).translate('kids_by_age'),
                    style: const TextStyle(
                        fontSize: 16, fontWeight: FontWeight.bold),
                  ),
                  Text(AppLocalizations.of(context).translate('older'),
                      style: const TextStyle(fontSize: 14)),
                  Text(AppLocalizations.of(context).translate('younger'),
                      style: const TextStyle(fontSize: 14)),
                  Text(AppLocalizations.of(context).translate('baby'),
                      style: const TextStyle(fontSize: 14)),
                ],
              ),
            ),
