...
import 'package:new_travel/pages/blog_details.dart';
                  ...
                  onTap: () {
                    nextScreen(
                        ...
                        PlaceDetailsPage(
                          ...
                          filename: bb.placeData[index]['file_name'],
                          images: [bb.placeData[index]['image-1']] +
                              bb.placeData[index]['images'],
                          tag: 'bookmarkPlace$index',
                        ));
                  },
                ))));
