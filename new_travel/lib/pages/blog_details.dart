          ...
          child: Column(
              ...
              children: <Widget>[
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Share.share(
                              '${widget.title}, To read more install ${Config().appName} App. https://play.google.com/store/apps/details?id=com.kulturos.centras');
                        },
                      ),
                    ],
                  ),
                ...
                Padding(
                  ...
                  child: Html(style: {
                    "body": Style(
                        fontSize: FontSize(17.0), fontWeight: FontWeight.w500)
                  }, data: '''  ${widget.description}   '''),
                ),
                SizedBox(
                  height: 30,
