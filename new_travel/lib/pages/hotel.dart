...
import 'package:new_travel/models/hotel.dart';
...
class HotelPage extends StatefulWidget {
  ...
  HotelPage({Key? key, @required this.lat, this.lng}) : super(key: key);
  ...
  void openEmptyDialog() {
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            content: Text("We didn't find any nearby hotels in this area"),
            title: Text(
              'No Hotels Found',
